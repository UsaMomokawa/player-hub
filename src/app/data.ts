...
const characters = [
  ...
  },
  {
    ...
    furigana: "さくま いちか",
    age: 28,
    memo: "宗教家。気怠げで、ぶつぶつ棒読みで喋る。\n中性的な見た目をしている男性。\n\n趣味は漫画を読むこと。\n特に少女漫画が好き。\n「花柵イチゴ」というペンネームで少女漫画を描いている。\n絵は下手。\n説教という体裁で信者に自作漫画を読ませている。",
    scenarios: ["悪辣(HO4)"],
  },
  {
    id: "yoshiki_syusui",
